...
<head>
  ...
  <link rel="icon" href="<?php echo base_url(); ?>assets_style/image/logo.png">
...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/buku1.png'); ?>')no-repeat;background-size:100%;">
  <div class="login-box">
    <br />
    <div class="login-logo">
      <a href="index.php" style="color: blue-light;"><b>PERPUSTAKAAN</b></a>
    </div>
    ...
    <div class="login-box-body" style="border:2px solid #226bbf;">
      ...
      <form action="<?= base_url('login/auth'); ?>" method="POST">
        <div class="form-group has-feedback">
          <input type="text" class="form-control" placeholder="NIM atau ID" id="user" name="user" required="required" autocomplete="off">
    ...
    <footer>
      <div class="login-box-body text-center bg-blue">
        <a style="color: White;"> Perpustakaan PBP <?php echo date("Y"); ?>
      </div>
    </footer>
  </div>
  <!-- /.login-box -->
